 ...
 */
function readBody(body: Record<string, unknown>): { countryId: number; bands: Band[] } | string {
...
export async function PUT(req: NextRequest) {
  ...
  try {
    ...
    await withActor(session.user.email, (tx) =>
      replaceKursTiers(parsed.countryId, parsed.bands, tx),
    )
